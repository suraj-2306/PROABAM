function answer = ABM(i, j)
	%command = "cat verilog_Code.v >> template.v";
	%diary('verilog_Code.v');
	a = con_dec_bin(i);
	b = con_dec_bin(j);

		stage1_results = od_to_td_ABM(pp_gen(a, b));
		stage2_results = stage1_2_ABM(stage1_results);
		stage3_results = stage2_3_ABM(stage2_results);
		stage4_results = stage3_4_ABM(stage3_results);
		stage5_results = stage4_5_ABM(stage4_results);
		stage6_results = stage5_6_ABM(stage5_results);
		stage7_results = stage6_cla_ABM(stage6_results);
